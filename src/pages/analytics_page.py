...
layout = dbc.Container([
    html.Div([
        ...
        html.Img(src="/assets/corr_matrix_unannotated.png", className="img-fluid mb-3"),
        html.P(
        ...
        html.Img(src="/assets/corr_matrix_annotated.png", className="img-fluid mb-3"),
        html.P(
        ...
        html.Img(src="/assets/churn_tenure_bucket.png", className="img-fluid mb-3"),
        html.P(
        ...
        html.Img(src="/assets/churn_contract_type.png", className="img-fluid mb-3"),
        html.P(
        ...
        html.Img(src="/assets/log_totalcharges_box.png", className="img-fluid mb-3"),
        html.P(
            "Lower total charges are correlated with higher churn, suggesting newer or lower-value customers are more at risk."
        ),

        html.Img(src="/assets/monthlycharges_box.png", className="img-fluid mb-3"),
        html.P(
